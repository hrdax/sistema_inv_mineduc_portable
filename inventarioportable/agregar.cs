...
namespace inventarioportable
{
    public partial class agregar : Form
    {
        ...
        {
            if(ingreso_nombres.Text == "" & ingreso_apellidos.Text== "" & ingreso_RUT.Text == ""
                & cbox_departamento.Text == "" & cbox_unidad.Text == "" & cbox_tipo_equipo.Text == ""
                & ingreso_marca.Text == "" & ingreso_modelo.Text == "" & ingreso_serie.Text == ""
                & ingreso_inventario.Text == "" & ingreso_usuario.Text == "" & ingreso_nombre_equipo.Text == ""
                & ingreso_MAC.Text == "" & ingreso_RAM.Text == "" & ingreso_espacio.Text == ""
                & ingreso_procesador.Text == "" & cbox_vwindows.Text == "" & cbox_voffice.Text == "" & cbox_lojack.Text == "")
            {
                MessageBox.Show("Por favor rellene al menos 1 campo para agregar");
                return false;
            }
            else
            {
